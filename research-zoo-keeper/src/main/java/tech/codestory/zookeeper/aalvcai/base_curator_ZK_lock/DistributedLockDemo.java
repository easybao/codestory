...
//	private TestingCluster testingCluster;
	...
	public void semaphore2() throws Exception {
		SharedCount sharedCount = new SharedCount(client, lockPath, 6);
		sharedCount.start();
		SharedCount sharedCount2 = new SharedCount(client2, lockPath, 6);
		sharedCount2.start();
		System.out.println(sharedCount.getCount());
		System.out.println(sharedCount2.getCount());
		// 创建一个信号量
		InterProcessSemaphoreV2 semaphore = new InterProcessSemaphoreV2(client, lockPath, sharedCount);
		System.out.println(sharedCount.getCount());
		InterProcessSemaphoreV2 semaphore2 = new InterProcessSemaphoreV2(client2, lockPath, sharedCount2);
		System.out.println(sharedCount2.getCount());
		// semaphore2 用于模拟其他客户端
		System.out.println(sharedCount.getCount());
		System.out.println(sharedCount2.getCount());
